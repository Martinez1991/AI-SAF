...
| AI.V14.3 | Verify that critical AI state (configurations, system prompts, guardrail policies, vector indexes, agent memory) is backed up, integrity-protected, and demonstrably recoverable. | | ✓ | | LLM10, ISO |
...
and agent memory. Verify backups are integrity-protected (signed or checksummed) and
perform a restore drill to confirm recoverability (links to AI.V7, AI.V9).
