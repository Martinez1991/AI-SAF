...
- [ ] Injection detection wired before the model; detections logged (AI.V6.2)
...
- [ ] Tool inputs schema-validated; tool outputs treated as untrusted (AI.V8.4)
- [ ] High-impact actions gated by policy / human confirmation (AI.V8.5)
- [ ] Output validation + PII/secret masking before delivery (AI.V10.2/.4)
